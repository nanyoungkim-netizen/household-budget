...
export const transactions: Transaction[] = [
  // 이번 달 수입
  { id: 't1', date: `${monthStr}-05`, description: '급여', amount: 3200000, type: 'income', accountId: 'kb', categoryId: 'salary' },
  { id: 't2', date: `${monthStr}-10`, description: '토스뱅크 이자', amount: 8500, type: 'income', accountId: 'toss', categoryId: 'interest' },
  // 이번 달 지출
  { id: 't3', date: `${monthStr}-02`, description: '관리비', amount: 85000, type: 'expense', accountId: 'kb', categoryId: 'living' },
  { id: 't4', date: `${monthStr}-03`, description: '마트 장보기', amount: 72000, type: 'expense', accountId: 'toss', categoryId: 'daily' },
  { id: 't5', date: `${monthStr}-04`, description: '점심식사', amount: 12000, type: 'expense', accountId: 'toss', categoryId: 'food' },
  { id: 't6', date: `${monthStr}-05`, description: '버스/지하철', amount: 55000, type: 'expense', accountId: 'kb', categoryId: 'transport' },
  { id: 't7', date: `${monthStr}-07`, description: '유튜브 프리미엄', amount: 14900, type: 'expense', accountId: 'toss', categoryId: 'subscription' },
  { id: 't8', date: `${monthStr}-08`, description: '현대해상 보험', amount: 89000, type: 'expense', accountId: 'kb', categoryId: 'insurance' },
  { id: 't9', date: `${monthStr}-09`, description: '카페라떼', amount: 6500, type: 'expense', accountId: 'toss', categoryId: 'drink' },
  { id: 't10', date: `${monthStr}-10`, description: '외식 (삼겹살)', amount: 45000, type: 'expense', accountId: 'kb', categoryId: 'food' },
  { id: 't11', date: `${monthStr}-11`, description: '주택청약', amount: 200000, type: 'expense', accountId: 'kb', categoryId: 'saving' },
  { id: 't12', date: `${monthStr}-12`, description: 'KT 통신비', amount: 55000, type: 'expense', accountId: 'kb', categoryId: 'communication' },
  { id: 't13', date: `${monthStr}-13`, description: '쿠팡 생필품', amount: 38000, type: 'expense', accountId: 'toss', categoryId: 'daily' },
  { id: 't14', date: `${monthStr}-14`, description: '피아노 레슨', amount: 150000, type: 'expense', accountId: 'kb', categoryId: 'selfdev' },
  { id: 't15', date: `${monthStr}-15`, description: '배달음식', amount: 28000, type: 'expense', accountId: 'toss', categoryId: 'food' },
  // 지난 달
  { id: 't16', date: `${prevMonthStr}-05`, description: '급여', amount: 3200000, type: 'income', accountId: 'kb', categoryId: 'salary' },
  { id: 't17', date: `${prevMonthStr}-03`, description: '관리비', amount: 85000, type: 'expense', accountId: 'kb', categoryId: 'living' },
  { id: 't18', date: `${prevMonthStr}-08`, description: '현대해상 보험', amount: 89000, type: 'expense', accountId: 'kb', categoryId: 'insurance' },
  { id: 't19', date: `${prevMonthStr}-10`, description: '외식', amount: 60000, type: 'expense', accountId: 'kb', categoryId: 'food' },
  { id: 't20', date: `${prevMonthStr}-15`, description: '쇼핑', amount: 120000, type: 'expense', accountId: 'kb', categoryId: 'shopping' },
]
...
export const goals: Goal[] = [
  { id: 'g1', name: '1억 모으기', targetAmount: 100000000, currentAmount: 31300000, deadline: '2030-12-31', color: '#0064FF' },

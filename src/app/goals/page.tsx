...
export default function GoalsPage() {
  ...
  function handleDelete(id: string) { setGoals(goals.filter(g => g.id !== id)) }
  ...
  return (
    <div className="p-4 md:p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-5">
        ...
        <button onClick={() => setShowModal(true)} className="bg-blue-600 text-white text-sm font-medium px-4 py-2 rounded-xl hover:bg-blue-700 transition-colors">+ 목표 추가</button>
      </div>
            ...
            <div key={goal.id} className="bg-white rounded-2xl p-5 shadow-sm">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white text-xl" style={{ backgroundColor: goal.color }}>🎯</div>
                  <div>
              ...
              {!isDone && daysLeft > 0 && (
                <div className="bg-gray-50 rounded-xl p-3 mb-3">
                  ...
                  <div className="text-sm font-semibold text-gray-700 mt-0.5">{fmtKRW(monthlyNeeded)}/월</div>
                </div>
              )}
              {!isDone && (
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-end md:items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md p-5 shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-bold">목표 추가</h2>
